...
import contactInterface, { contactToCreate } from '../../interfaces/contactInterface';
...
const ContactUpdate = () => {
    ...
    const onFinish = async (values:contactToCreate) => {
       ...
       fileReader.onload = () => {
         axios(`/contacts/${id}`, {
            method: 'PUT',
            data: {...values , photograph:fileReader.result, user_id:localStorage.getItem('id'), id: id},
